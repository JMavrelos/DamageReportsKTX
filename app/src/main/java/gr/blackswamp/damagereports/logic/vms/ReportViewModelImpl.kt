...
//import gr.blackswamp.damagereports.ui.activities.ReportActivityCommand
...
//class ReportViewModelImpl(application: Application, runInit: Boolean = true) : BaseViewModel(application), ReportViewModel,
//    ReportListViewModel {
//    companion object {
