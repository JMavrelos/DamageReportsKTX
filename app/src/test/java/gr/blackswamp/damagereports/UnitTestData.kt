...
import gr.blackswamp.core.Helpers.randomDate
import gr.blackswamp.core.Helpers.randomString
...
object UnitTestData {
    ...
    val DAMAGES: List<DamageEntity> = (0 until 60).map { DamageEntity(UUID.randomUUID(), "${randomString(10)} Damage", "${randomString(10)} Damage Description", REPORTS[it / 2].id) }
